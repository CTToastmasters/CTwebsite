<?php
	$mail_type = 'ce';
	//-----------------------------------------------------------------------------------------
    $to_Email       = 'capetowntoastmasters@gmail.com'; //Replace with recipient email address
    $subject        = 'CTTM Website Enquiry'; //Subject line for emails

    // your recaptcha secret key
    $secret = '6LfI418UAAAAANkekISR3dh3j0ACuORitjfaew0K';      // Add your reCAPTCHA secret key
    //-----------------------------------------------------------------------------------------
